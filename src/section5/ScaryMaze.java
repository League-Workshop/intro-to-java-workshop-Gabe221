...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("mazee.png"));
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor==(BC)){
			...
			scare=ImageIO.read(getClass().getResource("StandardScarySound"));
		}
	...
	private int RGB(int i, int j, int k) {
